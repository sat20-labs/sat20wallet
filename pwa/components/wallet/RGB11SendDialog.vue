  ...
  <Dialog :open="isOpen" @update:open="isOpen = $event">
    <DialogContent class="max-h-[90vh] w-[380px] overflow-y-auto rounded-lg bg-black">
      ...
      <div class="space-y-4">
        ...
        <Button class="w-full" :disabled="loading || !invoice.trim() || !!transferId" @click="prepare">
        ...
        <div v-if="transferPackage" class="space-y-2">
          ...
          <Textarea :model-value="transferPackage" readonly spellcheck="false"
        ...
        <div v-if="transferId" class="space-y-2">
          ...
          <Button class="w-full" :disabled="loading || (!outOfBand && !ack.trim())" @click="broadcast">
...
const props = defineProps<{ asset: { ticker?: string; contract_id?: string } | null }>()
