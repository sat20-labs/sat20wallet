  ...
  <LayoutApprove @confirm="confirm" @cancel="cancel">
    <div class="p-4 space-y-4">
      ...
      <div class="space-y-2">
        ...
        <div>
          <span class="font-semibold">{{$t('invokeContractSatsNet.assetName', '资产名称')}}：</span>
          <span>{{ props.data?.assetName || '-' }}</span>
        </div>
        <div>
          <span class="font-semibold">{{$t('invokeContractSatsNet.amt', '数量')}}：</span>
          <span>{{ props.data?.quantityNum || '-' }}</span>
        </div>
        <div>
          <span class="font-semibold">{{$t('invokeContractSatsNet.serviceFee', '服务费')}}：</span>
          <span>{{ props.data?.serviceFee || '-' }} sats</span>
        </div>
        <div>
